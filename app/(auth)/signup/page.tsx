    ...
    <div className="flex flex-col justify-center    overflow-hidden w-full max-w-md mx-auto p-4 ">
      ...
      <div className="flex flex-col gap-4 mt-6">
        <div>
          ...
          <Input className="py-4" type="text" placeholder="John" />
        </div>
        ...
        <div>
          ...
          <Input className="py-4" type="text" placeholder="Doe" />
        </div>
        <div>
          <label className="text-gray-600 text-sm" htmlFor="">
            Email Address
      ...
      <div className="flex justify-center mt-8">
        <Button className="w-full cursor-pointer px-4 py-2 bg-rose-800 text-white hover:bg-rose-900">
          {" "}
          Sign Up
        </Button>
      </div>
